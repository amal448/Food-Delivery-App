import { Calendar, Home, Inbox, Settings, X } from "lucide-react";
...
export function AppSidebar({ onClose }) {
  ...
  // ✅ Declare items outside the condition
  let items = [];

  if (user?.userData?.role === "deliveryBoy") {
    items = [
      {
        title: "My Location",
        url: "/delivery",
